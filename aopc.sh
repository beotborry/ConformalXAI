python3 aopc.py --seed 0 --num_data 1000 --expl_method "GradCAM" --mode "insertion" --tester "ConfAOPC"
...
python3 aopc.py --seed 0 --num_data 1000 --expl_method "LayerXAct" --mode "insertion" --tester "ConfAOPC"
...
python3 aopc.py --seed 0 --num_data 1000 --expl_method "LayerDL" --mode "insertion" --tester "ConfAOPC"
